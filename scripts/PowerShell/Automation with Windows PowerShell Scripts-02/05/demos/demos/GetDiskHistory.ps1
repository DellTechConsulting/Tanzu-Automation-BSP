...
$CSV = "C:\Users\bhavanishankar_pradh\OneDrive - Dell Technologies\DELL-Project-Data\Scripts\PowerShell\Automation with Windows PowerShell Scripts-02\05\demos\demos\diskhistory.csv"
...
#sample usage
# .\GetDiskHistory.ps1 -Computername W10316N2X2,DOM1,FOO,Srv1,srv2